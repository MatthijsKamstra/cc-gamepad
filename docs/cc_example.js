...
sketcher_draw_Text.prototype = $extend(sketcher_draw_Base.prototype,{
	...
	,__properties__: $extend(sketcher_draw_Base.prototype.__properties__,{set_style:"set_style",get_style:"get_style",set_textAlign:"set_textAlign",get_textAlign:"get_textAlign",set_textBaseline:"set_textBaseline",get_textBaseline:"get_textBaseline",set_fontWeight:"set_fontWeight",get_fontWeight:"get_fontWeight",set_fontFamily:"set_fontFamily",get_fontFamily:"get_fontFamily",set_fontSizePx:"set_fontSizePx",get_fontSizePx:"get_fontSizePx",set_fontSize:"set_fontSize",get_fontSize:"get_fontSize",set_str:"set_str",get_str:"get_str"})
});
...
var sketcher_lets_Go = function(target,duration) {
	...
	if(this.DEBUG) {
		window.console.log("New Go - _id: \"" + this._id + "\" / _duration: " + this._duration + " / _initTime: " + this._initTime + " / _tweens.length: " + sketcher_lets_Go._tweens.length);
	}
	haxe_Timer.delay($bind(this,this.init),1);
};
$hxClasses["sketcher.lets.Go"] = sketcher_lets_Go;
...
sketcher_lets_Go.wiggle = function(target,x,y,wiggleRoom) {
	...
	var _go1 = new sketcher_lets_Go(target,_go);
	_go1._isWiggle = true;
	var max = wiggleRoom;
	var min = -wiggleRoom;
	...
	_go1._easing = sketcher_lets_easing_Sine.get_easeInOut();
...
sketcher_lets_Go.orbit = function(target,x,y,radius,speed) {
	...
	var _this2 = _go._props;
	if(__map_reserved["cx"] != null) {
		_this2.setReserved("cx",_range2);
	} else {
		_this2.h["cx"] = _range2;
	}
	if(_go._isFrom) {
	...
	var _this4 = _go._props;
	if(__map_reserved["radius"] != null) {
		_this4.setReserved("radius",_range4);
	} else {
		_this4.h["radius"] = _range4;
	}
	if(_go._isFrom) {
		_go.updateProperties(0);
	}
	...
	var _this5 = _go._props;
	if(__map_reserved["speed"] != null) {
		_this5.setReserved("speed",_range5);
	} else {
		_this5.h["speed"] = _range5;
	}
	if(_go._isFrom) {
		_go.updateProperties(0);
	}
	...
	var _this6 = _go._props;
	if(__map_reserved["angle"] != null) {
		_this6.setReserved("angle",_range6);
	} else {
		_this6.h["angle"] = _range6;
	}
	if(_go._isFrom) {
		_go.updateProperties(0);
	}
...
$hxClasses["sketcher.lets.easing.Quad"] = sketcher_lets_easing_Quad;
...
$hxClasses["sketcher.lets.easing.QuadEaseIn"] = sketcher_lets_easing_QuadEaseIn;
...
$hxClasses["sketcher.lets.easing.QuadEaseInOut"] = sketcher_lets_easing_QuadEaseInOut;
...
$hxClasses["sketcher.lets.easing.QuadEaseOut"] = sketcher_lets_easing_QuadEaseOut;
...
$hxClasses["sketcher.lets.easing.Sine"] = sketcher_lets_easing_Sine;
...
$hxClasses["sketcher.lets.easing.SineEaseIn"] = sketcher_lets_easing_SineEaseIn;
...
$hxClasses["sketcher.lets.easing.SineEaseInOut"] = sketcher_lets_easing_SineEaseInOut;
...
$hxClasses["sketcher.lets.easing.SineEaseOut"] = sketcher_lets_easing_SineEaseOut;
